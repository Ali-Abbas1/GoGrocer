              ...
              {footerLinks.map((items, id) => (
                <React.Fragment>
                  <li key={id} className="flex flex-col space-y-4">
                    {items.link1?.map((item) => (
                      <React.Fragment>
                        <a className="hover:underline f-u-r font-medium text-base cursor-pointer">
                          {item}
                        </a>
                      </React.Fragment>
                    ))}
          ...
          <div className="social-buttons flex space-x-4">
            <a>
              <svg
                ...
                focusable="false"
                viewBox="0 0 16 16"
                className="cd ce c6 cf"
                width={16}
                height={16}
              >
                <path d="M14.667 0H1.333C.597 0 0 .597 0 1.333v13.334C0 15.403.597 16 1.333 16h7.334v-6h-2V7.333h2V5.61c0-2.067 1.262-3.192 3.106-3.192.883 0 1.642.066 1.863.095v2.16h-1.279c-1.002 0-1.196.477-1.196 1.176v1.485h2.96L13.454 10h-2.293v6h3.506c.736 0 1.333-.597 1.333-1.333V1.333C16 .597 15.403 0 14.667 0z" />
              </svg>
            </a>
            <a>
              <svg
